...
/**
 * Buttons are fully pill-shaped (DS-CTL-01). The radius lives here rather than at
 * each call site — it used to be `rounded-md`, which is why call sites across the
 * app hand-wrote `rounded-full` to compensate. Note that the `sm`/`lg` sizes must
 * NOT re-declare a radius: a size-level `rounded-*` wins over this base string and
 * silently squares those buttons off again.
 */
