...
export function FloorPlanPropertiesPanel({
  ...
  const isTable = selectedTable.category === 'table' || selectedTable.category === 'booth'
  ...
  const updateProperty = (field: string, value: unknown) => {
    ...
    updateTableInDraft(selectedTable.id, { [field]: value } as Partial<FloorPlanObject>)
  }
    ...
    <div className="w-80 bg-background border-l border-border flex flex-col h-full overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => updateProperty('label_override', e.target.value || null)}
                placeholder="Max 20 chars"
                maxLength={20}
              />
              <p className="text-xs text-muted-foreground">Short label shown on table</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => updateProperty('zone_name', e.target.value || null)}
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProperty('capacity', e.target.value ? parseInt(e.target.value) : null)}
                    placeholder="4"
                    min={1}
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProperty('min_capacity', e.target.value ? parseInt(e.target.value) : null)}
                    placeholder="1"
                    min={0}
                  />
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => updateProperty('is_reservable', !!checked)}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => updateProperty('is_combinable', !!checked)}
                  />
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateProperty('default_turn_time', e.target.value ? parseInt(e.target.value) : null)}
                    placeholder="90"
                    min={1}
                  />
                  <p className="text-xs text-muted-foreground">Expected dining duration</p>
                </div>
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2 items-center">
                <input
                  ...
                  onChange={(e) => updateProperty('color_override', e.target.value)}
      ...
      <div className="border-t bg-muted/50 px-4 py-2 text-xs text-muted-foreground">
        <div className="space-y-1">
          <div>ID: <span className="font-mono">{selectedTable.id.slice(0, 8)}...</span></div>
          <div>Position: ({selectedTable.x.toFixed(0)}, {selectedTable.y.toFixed(0)})</div>
        </div>
      </div>
    </div>
  )
