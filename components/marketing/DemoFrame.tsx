    ...
    <>
      <div className="demo-meta">
        ...
        <div className="demo-meta-actions">
          ...
          <a href="/pos-demo/pos-app.html?v=20260826-2" target="_blank" className="demo-action-btn">
            ...
            <span className="demo-action-label-default">Open full screen</span>
            <span className="demo-action-label-mobile">Try POS</span>
          </a>
        </div>
      </div>
      ...
      <div className="device-frame">
        ...
        <div className="device-iframe-wrap">
          <iframe key={key} src="/pos-demo/pos-app.html?v=20260826-2" className="pos-iframe" title="DEXA Live Demo" loading="lazy" />
        </div>
      </div>
    </>
  );
