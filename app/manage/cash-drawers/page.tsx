...
// colSpan = expand col + HQ_SESSION_COLUMNS.length
...
function VarianceTrendsTab({
  ...
  // Qualified line key: "MerchantName / DrawerName" in multi-merchant, "DrawerName" in single
  ...
  // Sort by |total| desc, cap at 20 unless showing all
...
export default function HQCashDrawersPage() {
