...
interface VoidReceiptPreviewProps {
  formState: ReceiptTemplateFormData;
}

export function VoidReceiptPreview({ formState }: VoidReceiptPreviewProps) {
  return (
    <ReceiptPaper>
      {formState.show_logo && (
      ...
      {/* Original items */}
      <div className="space-y-1 line-through opacity-60">
        <div className="flex justify-between">
      ...
      <div className="text-[10px]">
        <div className="font-semibold">Void Reason:</div>
        <div className="text-zinc-500">Customer changed mind</div>
        <div className="text-zinc-500 mt-1">
          Voided by: Manager (John D.)
        </div>
