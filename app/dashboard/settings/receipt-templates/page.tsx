...
function formDataFromTemplate(
  ...
  return {
    ...
    show_loyalty_rewards: saved.show_loyalty_rewards ?? defaults.show_loyalty_rewards,
  ...
  const handleSave = useCallback(async () => {
    ...
    await upsertMutation.mutateAsync({
      ...
      input: {
        ...
        show_loyalty_rewards: formState.show_loyalty_rewards,
  ...
  const handleUseDefault = useCallback(async () => {
    ...
    await upsertMutation.mutateAsync({
      ...
      input: {
        ...
        show_loyalty_rewards: defaults.show_loyalty_rewards,
