      ...
      >
        <div className="container mx-auto flex items-center gap-3 px-4 py-3">
          <button
            ...
            style={{ color: "var(--header-text, var(--text))" }}
            onMouseEnter={(e) =>
              (e.currentTarget.style.backgroundColor = "color-mix(in srgb, var(--text) 10%, transparent)")
            }
            onMouseLeave={(e) =>
          ...
          <div>
            <h1
              ...
              style={{ fontFamily: "var(--font-display)", color: "var(--header-text, var(--text))" }}
            >
              Store Information
            </h1>
            <p className="text-xs" style={{ color: "var(--header-text, var(--text))", opacity: 0.7 }}>
              {storeName}
            </p>
          </div>
        </div>
