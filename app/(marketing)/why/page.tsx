...
const FAQ_ITEMS = [
  {
    ...
    a: (
      <>
        <p>
          It depends on volume. The DEXA software fee is competitive — but the
          real savings come from{" "}
          <strong>
            not paying captive-hardware margin and not paying captive-processor
            margin.
          </strong>{" "}
          On $1M+ in card volume per year, the processor difference alone usually
          pays for the entire DEXA subscription.
        </p>
        <p>
          For low-volume single locations, the dollar difference is smaller. For
          multi-unit operators, it compounds quickly. We&apos;re happy to run the
          math against your actual statements during the demo.
        </p>
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <p>
          For a single-location restaurant, two weeks. For a 5–10 location group,
          four to six weeks. Our migration team handles menu rebuild, staff PIN
          setup, hardware provisioning, and one week of on-site coverage during
          cutover.
        </p>
        <p>
          <strong>We don&apos;t do &quot;you&apos;re on your own&quot; migrations.</strong>{" "}
          Every DEXA deployment includes white-glove onboarding because a botched
          migration costs everyone money.
        </p>
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <p>
          If your existing processor supports our integrated terminals, keep
          them. If they don&apos;t, we&apos;ll introduce you to processors who do
          — typically at rates 15–30 basis points below what bundled-POS
          operators pay.
        </p>
        <p>
          We have no exclusive arrangement with any processor.{" "}
          <strong>
            We make our money from software, not from a transaction tax.
          </strong>
        </p>
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <p>
          DEXA keeps running. New orders fire to the kitchen. Cash settles.
          Tables merge. Drawers open. Refunds process under manager PIN. The
          customer never knows there was an issue.
        </p>
        <p>
          When connectivity returns, the queue syncs in the right order.{" "}
          <strong>You won&apos;t lose a transaction to a network outage.</strong>
        </p>
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <p>
          No. Software is month-to-month. Hardware you buy outright. There&apos;s
          no early termination fee, no minimum-volume clause, no automatic renewal
          that requires 90 days of written notice to escape.
        </p>
        <p>
          <strong>
            If we don&apos;t earn your business every month, you don&apos;t owe us
            next month.
          </strong>
        </p>
      </>
  ...
  },
  {
    ...
    a: (
      <>
        <p>
          Three cases. <strong>One:</strong> very low-volume operations doing
          under $100K per year — Square&apos;s free tier is genuinely cheaper.{" "}
          <strong>Two:</strong> operators who want zero configuration — DEXA gives
          you per-station tuning, which means somebody has to make decisions
          during onboarding. <strong>Three:</strong> operators who specifically
          want a bundled processor at a markup.
        </p>
        <p>
          If any of those describe you, we&apos;ll tell you on the call. We&apos;d
          rather lose a sale than lose a customer in month four.
        </p>
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <p>
          Over 1,200 restaurants across the United States. The mix skews toward
          full-service: coursing-heavy fine dining, multi-unit pizzeria groups,
          café chains, and bars with complex tab management.
        </p>
        <p>
          Largest deployment: 47 locations across two states.{" "}
          <strong>
            Smallest: a single food truck running offline-first because their
            commissary&apos;s Wi-Fi is unreliable.
          </strong>{" "}
          We&apos;re equally happy with both.
        </p>
      </>
    ),
  },
  {
    ...
    a: (
      <>
        <p>
          24/7 phone support, US-based. Real humans, no chatbot screening you out
          before you can speak to someone. Average response time under three
          minutes for urgent calls during service hours.
        </p>
        <p>
          Every account also gets a dedicated onboarding specialist for the first
          90 days.{" "}
          <strong>If you have a problem, you have a person.</strong>
        </p>
      </>
    ),
  },
  ...
  return (
    <main className="mk-why">
      ...
      <section className="page-head">
        <div className="wrap">
          ...
          <p className="lede reveal in" style={{ transitionDelay: ".2s" }}>
            No multi-year contracts, no captive hardware, no processor lock-in.
            Here&apos;s how DEXA stacks up against the platforms most operators
            evaluate — and the questions they ask before switching.
          </p>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="section-head center reveal in">
            ...
            <p className="section-sub">
              An honest side-by-side. Here&apos;s how DEXA stacks up against the
              platforms most operators evaluate.
            </p>
          </div>
          ...
          <div className="comp-card reveal in">
            ...
            <div className="comp-table">
              ...
              <div className="comp-cell" style={{ borderBottom: "1px solid var(--slate-100)" }}>
                <span style={{ background: "var(--brand-50)", color: "var(--brand-500)", padding: "5px 12px", borderRadius: "6px", fontWeight: 600, fontSize: "12.5px" }}>
                  Built in
                </span>
              </div>
              ...
              <div className="comp-row" style={{ borderBottom: "none" }}>
                <div className="comp-row-feature" style={{ borderBottom: "none" }}>
                  Multi-location
                </div>
              </div>
              <div className="comp-cell" style={{ borderBottom: "none" }}>
                <span style={{ background: "var(--brand-50)", color: "var(--brand-500)", padding: "5px 12px", borderRadius: "6px", fontWeight: 600, fontSize: "12.5px" }}>
                  Unlimited
                </span>
              </div>
              <div className="comp-cell competitor" style={{ borderBottom: "none" }}>
                Tier-based
              </div>
              <div className="comp-cell competitor" style={{ borderBottom: "none" }}>
                Limited
      ...
      <section className="why-diff">
        <div className="wrap">
          <div className="section-head center reveal in">
            ...
            <p className="section-sub">
              The table above is the summary. Here&apos;s the substance behind
          ...
          <div className="wp-inner reveal in">
            ...
            <div className="wp-plans">
              <div className="wp-plan">
                <span className="wp-price">$99</span>
                <span className="lbl">/mo</span>
                <span className="add">First station</span>
              </div>
              <div className="wp-plan">
                <span className="wp-price">$49</span>
                <span className="lbl">/mo</span>
                <span className="add">Additional station</span>
              </div>
              <div className="wp-plan">
                <span className="wp-price">$39</span>
                <span className="lbl">/mo</span>
                <span className="add">Handheld tablet</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="cta-strip">
        <div className="wrap">
          <div className="section-eyebrow" style={{ color: "var(--brand-300)", justifyContent: "center" }}>
            Run the math
          </div>
