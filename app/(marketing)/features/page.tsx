        ...
        <div className="wrap">
          ...
          <div className="core-grid reveal-stagger in">
            <div className="core-card">
              <div className="core-image" style={{ backgroundImage: "url('/dexa-dp2.png')" }}></div>
            ...
            <div className="core-card">
              <div className="core-image" style={{ backgroundImage: "url('/dexa-og2.png')" }}></div>
              <div className="core-body">
                <div className="core-icon">
            ...
            <div className="core-card">
              <div className="core-image" style={{ backgroundImage: "url('/dexa-kds2.png')" }}></div>
              <div className="core-body">
                <div className="core-icon">
            ...
            <div className="core-card">
              <div className="core-image" style={{ backgroundImage: "url('/dexa-cash.png')" }}></div>
              <div className="core-body">
                <div className="core-icon">
            ...
            <div className="core-card">
              <div className="core-image" style={{ backgroundImage: "url('/dexa-analytics3.png')" }}></div>
              <div className="core-body">
                <div className="core-icon">
            ...
            <div className="core-card">
              <div className="core-image" style={{ backgroundImage: "url('/dexa-hw1.png')" }}></div>
              <div className="core-body">
                <div className="core-icon">
          ...
          <div className="cap-grid reveal-stagger in">
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>Coursing</span><span>Split checks</span><span>Modifiers</span><span>Open tabs</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>Cash discount</span><span>Tip-at-sale</span><span>Apple Pay</span><span>Pre-auth tabs</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>Website</span><span>Uber Eats</span><span>DoorDash</span><span>Grubhub</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>KDS</span><span>Allergen flags</span><span>Aging timers</span><span>Routing</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>Menu builder</span><span>Auto-deduct</span><span>Stock alerts</span><span>Schedules</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>PIN login</span><span>Roles</span><span>Scheduling</span><span>Tip splits</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>Live sales</span><span>Menu engineering</span><span>Closeout</span><span>P&amp;L</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>Phone signup</span><span>Points</span><span>SMS</span><span>Offers</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>QuickBooks</span><span>Tax</span><span>Payroll</span><span>API</span>
              </div>
            </div>
            ...
            <div className="cap">
              ...
              <div className="cap-pills">
                <span>Central menu</span><span>Overrides</span><span>Group P&amp;L</span><span>Permissions</span>
              </div>
            </div>
          </div>
        </div>
