...
1. category popup pilot: `docs/SPRINT-2026-03-28-HQ-CATEGORY-POPUP-PILOT.md`
2. menu and item popup rollout: `docs/SPRINT-2026-03-30-HQ-MENU-ITEM-POPUP-ROLLOUT.md`
3. popup inventory and broader rollout plan: `docs/SPRINT-2026-03-28-POPUP-STANDARDIZATION.md`
4. HQ menu parity work: `docs/SPRINT-2026-03-28-HQ-MENU-PARITY.md`
5. Bunny CDN migration: `docs/SPRINT-2026-03-21-BUNNY-CDN-MIGRATION-PLAN.md`
