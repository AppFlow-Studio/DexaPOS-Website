...
- `docs/FEATURE-ONLINE-STORE-HQ-REQUEST-FLOW.md` now states:
  - merchant has no payment/tips access
  - HQ owns payment credentials/tipping
- `docs/HANDOFF-2026-04-11-SENIOR-ONLINE-ORDERING-DEJAVOO.md` includes the merchant restriction note.
