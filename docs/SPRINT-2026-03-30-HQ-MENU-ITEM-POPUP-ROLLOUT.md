...
2. popup inventory and broader rollout plan: `docs/SPRINT-2026-03-28-POPUP-STANDARDIZATION.md`
3. HQ menu parity work: `docs/SPRINT-2026-03-28-HQ-MENU-PARITY.md`
4. Bunny CDN migration: `docs/SPRINT-2026-03-21-BUNNY-CDN-MIGRATION-PLAN.md`
