...
1. Bunny CDN migration is tracked separately in `docs/features/cdn-assets/SPRINT-2026-03-21-BUNNY-CDN-MIGRATION-PLAN.md`
2. broader popup inventory and rollout planning is tracked in `docs/features/admin-platform/SPRINT-2026-03-28-POPUP-STANDARDIZATION.md`
