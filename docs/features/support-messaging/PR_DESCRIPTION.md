...
Full spec, root-cause findings, acceptance criteria and QA matrices: [`docs/features/support-messaging/wire-up-hardening-support-marketing-telnyx.md`](./wire-up-hardening-support-marketing-telnyx.md).
