...
It supersedes `docs/features/qr-dine-in/PLAN-2026-05-20-QR-DINE-IN-FOUNDATION.md` for implementation planning and status tracking. The older doc remains historical context only.
