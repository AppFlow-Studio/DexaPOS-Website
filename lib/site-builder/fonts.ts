...
export const SITE_FONTS: SiteFont[] = [
...

  {
    id: "figtree",
    name: "Figtree",
    stack: `"Figtree", ${SANS_FALLBACK}`,
    google: "Figtree:wght@400;500;600;700",
    category: "Sans",
    roles: ["heading", "body"],
    note: "Open and modern, a touch softer than Inter",
  },
  {
    id: "plus-jakarta",
    ...
    category: "Sans",
    roles: ["heading", "body"],
    note: "Crisp and slightly quirky — reads well large or small",
  },
  {
    id: "rubik",
    name: "Rubik",
    ...
    category: "Sans",
    roles: ["heading", "body"],
    note: "Rounded corners, approachable and a little playful",
  },
  {
    id: "nunito",
    name: "Nunito",
    ...
    category: "Sans",
    roles: ["heading", "body"],
    note: "Fully rounded and warm — family restaurants, cafes",
  },
  {
    id: "montserrat",
    name: "Montserrat",
    ...
    category: "Sans",
    roles: ["heading", "body"],
    note: "Wide geometric caps that hold their own as headlines",
  },
  {
    id: "raleway",
    name: "Raleway",
    ...
    category: "Sans",
    roles: ["heading", "body"],
    note: "Elegant and thin-stroked, good above short lines",
  },

  {
    ...
    category: "Serif",
    roles: ["heading", "body"],
    note: "Old-style and quietly traditional — bistros, wine lists",
  },
  {
    id: "crimson-pro",
    name: "Crimson Pro",
    stack: `"Crimson Pro", ${SERIF_FALLBACK}`,
    google: "Crimson+Pro:wght@400;500;600;700",
    category: "Serif",
    roles: ["heading", "body"],
    note: "Book serif built for reading long descriptions",
  },
  {
    id: "bitter",
    name: "Bitter",
    stack: `"Bitter", ${SERIF_FALLBACK}`,
    google: "Bitter:wght@400;500;600;700",
    category: "Serif",
    roles: ["heading", "body"],
    note: "Slab serif with a sturdy, contemporary feel",
  },
  {
    id: "spectral",
    name: "Spectral",
    ...
    category: "Serif",
    roles: ["heading", "body"],
    note: "Screen-first serif, crisp without feeling formal",
  },
...

  {
    id: "archivo-black",
    name: "Archivo Black",
    stack: `"Archivo Black", "Arial Black", ${SANS_FALLBACK}`,
    google: "Archivo+Black",
    category: "Display",
    roles: ["heading"],
    note: "Solid grotesque weight — confident without shouting",
  },
  {
    id: "fjalla-one",
    name: "Fjalla One",
    stack: `"Fjalla One", "Arial Narrow", ${SANS_FALLBACK}`,
    google: "Fjalla+One",
    category: "Display",
    roles: ["heading"],
    note: "Condensed with softened corners, friendlier than Oswald",
  },
  {
    id: "alfa-slab",
    name: "Alfa Slab One",
    stack: `"Alfa Slab One", ${SERIF_FALLBACK}`,
    google: "Alfa+Slab+One",
    category: "Display",
    roles: ["heading"],
    note: "Fairground slab serif — pizza, diners, dessert bars",
  },
  {
    id: "abril-fatface",
    name: "Abril Fatface",
    stack: `"Abril Fatface", ${SERIF_FALLBACK}`,
    google: "Abril+Fatface",
    category: "Display",
    roles: ["heading"],
    note: "High-contrast display serif with a fashion-magazine air",
  },
  {
    id: "righteous",
    name: "Righteous",
    stack: `"Righteous", ${SANS_FALLBACK}`,
    google: "Righteous",
    category: "Display",
    roles: ["heading"],
    note: "Retro geometric caps — cocktail bars and taprooms",
  },
  {
    id: "staatliches",
    name: "Staatliches",
    stack: `"Staatliches", "Arial Narrow", ${SANS_FALLBACK}`,
    google: "Staatliches",
    category: "Display",
    roles: ["heading"],
    note: "Poster lettering, all caps by design",
  },
  ...
  },
  {
    id: "caveat",
    name: "Caveat",
    stack: `"Caveat", ${SANS_FALLBACK}`,
    google: "Caveat:wght@400;600;700",
    category: "Handwritten",
    roles: ["heading"],
    note: "Quick marker script, like a specials board",
  },
  {
    id: "satisfy",
    name: "Satisfy",
    stack: `"Satisfy", ${SANS_FALLBACK}`,
    google: "Satisfy",
    category: "Handwritten",
    roles: ["heading"],
    note: "Relaxed brush script with a vintage sign-painter feel",
  },
  {
    id: "dancing-script",
    name: "Dancing Script",
    stack: `"Dancing Script", ${SANS_FALLBACK}`,
    google: "Dancing+Script:wght@400;600;700",
    category: "Handwritten",
    roles: ["heading"],
    note: "Bouncy and informal — cafes, patisseries, gelato",
  },
];
