-- ============================================================================
-- Migration 046: Fix tax_category 'default' -> 'standard' in online orders
-- ============================================================================
-- The process_online_order RPC and all online order tax queries used
-- tax_category = 'default', but the actual DB seed data uses 'standard'.
-- This caused tax lookups to return NULL/0, meaning customers were not
-- charged tax on online orders.
-- ============================================================================

-- Fix any existing seed data that might use 'default'
UPDATE public.tax_rates
SET tax_category = 'standard'
WHERE tax_category = 'default';

-- Backfill order_source for existing online orders that defaulted to 'pos'
...
-- Recreate the RPC with the corrected tax_category filter and order_source = 'online'
...
BEGIN
  ...
  -- FIX: Changed tax_category from 'default' to 'standard'
  -- ========================================================================
  ...
  INSERT INTO public.orders (
    ...
    v_order_type, 'online', v_status, 'paid'::public.payment_status,
...
COMMENT ON FUNCTION public.process_online_order IS 'Universal online order processor. v3: fixed tax_category from default to standard, set order_source to online.';
