...
-- Extends the live definition (20260615213914_get_kds_tickets_v2_ready_time)
-- by adding 'is_to_go' to each item's jsonb, right next to 'is_prioritized'.
-- No other changes. Requires the is_to_go column (prior migration).
-- ============================================================================
