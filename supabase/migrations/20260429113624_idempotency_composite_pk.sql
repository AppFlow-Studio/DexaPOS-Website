-- Wave 3.0c: composite (key, op) PK on idempotency_keys
-- Closes cross-op cache pollution hazard. Pre-flight verified:
-- - constraint name: idempotency_keys_pkey
-- - op column: text NOT NULL
-- - 66 rows currently (will be TRUNCATEd; pg_cron purges daily)
-- - no dependent views/triggers/policies
