-- Fix admin settlement batch reporting: settlement_batches stores numeric
-- dollars, not cents. The original get_admin_settlement_batches RPC divided
-- gross_amount/tip_amount/refund_amount/net_deposit by 100, which made admin
-- batch totals show 1/100th of reality (e.g. $0.68 instead of $580.70) and
-- produced false discrepancies versus the linked-payment dollar sums.
