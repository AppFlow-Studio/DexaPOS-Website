-- =====================================================================
-- Rollback: broadcast_order_changes v3 payload trim -> restore v2
-- =====================================================================
-- Restores the v2 definition captured VERBATIM from live prod
-- (hifouuofcaytijrkbvcy) via pg_get_functiondef on 2026-07-13, which is
-- byte-identical to 20260712124000_broadcast_platform_order_number.sql
-- (verified same on staging dfwqakoyittmrwbqvxgw).
-- =====================================================================
...
COMMENT ON FUNCTION public.broadcast_order_changes() IS
  'Order-update broadcast trigger. v2 payload + SC snapshot columns + platform_order_number. Restored by v3 payload-trim rollback.';
