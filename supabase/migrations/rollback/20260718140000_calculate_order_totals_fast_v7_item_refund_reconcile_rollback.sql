-- =====================================================================
-- ROLLBACK for v7 (per-item-refund reconcile) — re-applies the v6 body verbatim.
-- Restores the payment-level custom_refund_balance for orders with per-item
-- refunds (i.e. reverts to the pre-v7 divergent amount_due behaviour).
-- =====================================================================
