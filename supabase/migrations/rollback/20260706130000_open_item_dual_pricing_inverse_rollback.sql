-- =====================================================================
-- Rollback: open-item dual pricing inverse -> original deployed bodies
-- =====================================================================
-- Restores add_open_item_v3, update_order_item_v2, update_order_item_v3 to the
-- pre-migration deployed definitions (cash = card * (1 - rate); add reads
-- location dual_pricing_percentage defaulting to 0.04; updates hardcode 0.04).
-- =====================================================================
...
BEGIN
    SELECT
        oi.order_id, oi.is_open_item, oi.quantity, oi.unit_price, oi.tax_rate, o.location_id
