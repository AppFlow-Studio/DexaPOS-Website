...
-- =====================================================================
-- Restores process_payment_v15 to the dp_fee_pct (20260606183812) body via an
-- in-place CREATE OR REPLACE (same name + 14-arg signature, idempotency op
-- 'process_payment_v15'). This reverts ONLY the ORD-S2-0001 item-payment
-- fully-paid fallback edit: the v_is_item_payment branch returns to deciding
-- fully-paid solely on v_unpaid_items_count. The dual_pricing_fee = pct × total
-- behavior is retained (this body IS the dp_fee_pct version). Body below is
-- verbatim the dp_fee_pct migration.
-- =====================================================================
--
