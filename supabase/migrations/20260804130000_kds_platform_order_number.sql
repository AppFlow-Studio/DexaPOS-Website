-- get_kds_tickets_v2: surface platform_order_number so KDS tickets can render
-- the delivery-platform short code (last-5, e.g. "C424D") on cold-load/refetch.
-- Only change vs prior def: one added key in the ticket jsonb_build_object.
