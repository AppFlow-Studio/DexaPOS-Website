CREATE OR REPLACE FUNCTION public.process_payment_v11(
    p_order_id uuid, p_payment_method text, p_amount numeric DEFAULT NULL::numeric,
    p_tip_amount numeric DEFAULT 0, p_amount_tendered numeric DEFAULT NULL::numeric,
    p_item_allocations jsonb DEFAULT NULL::jsonb, p_staff_id uuid DEFAULT NULL::uuid,
    p_terminal_response jsonb DEFAULT NULL::jsonb, p_split_count integer DEFAULT NULL::integer,
    p_split_portion_index integer DEFAULT NULL::integer, p_force_card_pricing boolean DEFAULT false,
    p_terminal_id uuid DEFAULT NULL::uuid, p_idempotency_key uuid DEFAULT NULL::uuid,
