-- C1: Add dietary_flags column to menu_items for storefront filter chips.
-- meal_types is used for meal occasions (Lunch/Dinner/Brunch/Specials) and
-- is not suitable for dietary labels — reusing it causes false negatives.
-- dietary_flags holds values like: Vegan, Vegetarian, Gluten-Free, Dairy-Free, Keto
