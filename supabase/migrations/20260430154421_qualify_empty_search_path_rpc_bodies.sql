...
BEGIN
    ...
    INSERT INTO public.order_payments (
        ...
        covers_items, split_portion_index, split_count, status,
        terminal_type, processed_by_staff_id, processor_response,
        reference_number, transaction_id, authorization_code,
        dejavoo_response_code, dejavoo_batch_number, dejavoo_invoice_number,
        card_type, card_last_four, captured_at, initiated_at,
        merchant_id, location_id, rrn, result_code, result_message, terminal_id
    ) VALUES (
        p_order_id,
    ...
    UPDATE public.orders SET
        ...
        payment_pricing_mode = v_new_pricing_mode::public.pricing_mode,
        cash_discount_applied = COALESCE(cash_discount_applied, false) OR v_use_cash_pricing,
        payment_status = CASE
            WHEN v_order_fully_paid THEN 'paid'::public.payment_status
            WHEN v_new_amount_paid > 0 THEN 'partial'::public.payment_status
