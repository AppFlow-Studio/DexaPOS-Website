-- =============================================================================
-- Migration: Update RPCs to support location-scoped modifier assignments
-- Changes: All three modifier-serving RPCs now UNION menu_item_modifier_groups
--          with location_item_modifier_groups to include location-specific
--          modifier assignments alongside global ones.
-- =============================================================================
                            ...
                            json_build_object(
                                ...
                                'menu_item', json_build_object(
                                    ...
                                    'modifier_groups', (
                                        ...
                                        FROM (
                                            SELECT modifier_group_id FROM menu_item_modifier_groups WHERE menu_item_id = mi.id
                                            UNION
                                            SELECT modifier_group_id FROM location_item_modifier_groups
