...
BEGIN
  ...
  -- Both aggregates filter out voided payments. Voided payments can carry a
  -- refunded_amount as a side-effect of the void path; counting it as a
  -- refund would misclassify mixed void+capture orders as fully refunded.
  SELECT
